...
Подмонтирую диск командой ```mount /dev/sr0 /media```.(рис. [-@fig:016])

![Подмонтирование диска](image/16.png){#fig:016 width=70%}

Устанавливаю драйвера.(рис. [-@fig:017])

![Установка драйверов](image/17.png){#fig:017 width=70%}

![Драйвера установлены](image/18.png){#fig:018 width=70%}


Так как имя пользователя уже соответсвует тому, имени пользователя в дисплейном классе, меняю только пароль для пользователя.(рис. [-@fig:019])

![Меняю пароль](image/19.png){#fig:019 width=70%}

Устанавливаю имя хоста командой ```hostnamectl set-hostname dmkazazaev``` и проверяю изменилось ли имя(рис. [-@fig:020])

![Установка и промерка имени хоста](image/20.png){#fig:020 width=70%}

Захожу на страницу pandoc crossref, чтобы узнать, какакая версия pandoc совместима и скачать архив с ПО.(рис. [-@fig:021])

![Страница pandoc crossref на GitHub](image/21.png){#fig:021 width=70%}

Перехожу на официальный сайт pandoc, чтобы скачать средство pandoc.(рис. [-@fig:022])

![Сайт pandoc](image/22.png){#fig:022 width=70%}

Перехожу на GitHub, где скачиваю архив pandoc-3.1.11.1-linux-amd64.tar.gz.(рис. [-@fig:023])

![Скачиваю pandoc с GitHub](image/23.png){#fig:023 width=70%}

Разархивирую файл pandoc.(рис. [-@fig:024])

![Разархивирование файлов pandoc](image/24.png){#fig:024 width=70%}

Разархивирую файлы pandoc crossref.(рис. [-@fig:025])
![Разархивирование файлов pandoc crossref](image/25.png){#fig:025 width=70%}

Дальше перемещаю разархивированные файлы в нужную дерикторию.(рис. [-@fig:026])

![Перемещение файлов](image/26.png){#fig:026 width=70%}

Устанавливаю первую часть файлов TexLive(рис. [-@fig:027])

![Установка TexLive](image/27.png){#fig:027 width=70%}

![Установленная чатсь TexLive](image/28.png){#fig:028 width=70%}

Доустанавливаю оставшиеся файлы TexLive и проверяю,установились ли некоторые файлы.(рис. [-@fig:029])

![Доустановка и проверка файлов TexLive](image/29.png){#fig:029 width=70%}

![Доустановка и проверка файлов TexLive](image/30.png){#fig:030 width=70%}

## Выполнение домашней работы.

Прописываю необходимую команду, чтобы начать анализ порядка запуска операционной системы.(рис. [-@fig:031])

![Выполнение команды dmesg](image/31.png){#fig:031 width=70%}

Анализирую порядок запуска операционной системы.(рис. [-@fig:032])

![Анализ](image/32.png){#fig:032 width=70%}

Далее ищу версию ядра Linux командой ```dmesg |grep -i «Linux version»```(рис. [-@fig:033])

![Версия Linux](image/33.png){#fig:033 width=70%}

Ищу информацию о частоте процессора и о самом процессоре командами ```dmesg |grep -i «Detected Mhz processor»``` и ```dmesg |grep -i «CPU0»```, правда первая команда не сработала.(рис. [-@fig:034])

![Поиск частоты процессора и информации о самом процессоре](image/34.png){#fig:034 width=70%}

Ищу гипервизор командой ```dmesg |grep -i «Hypervisor detected»```.(рис. [-@fig:035])

![Поиск информации о гипервизоре](image/35.png){#fig:035 width=70%}
